...
//header("Location: ".$Site_url."/api/v1/import.php?id=".$Store_Hash."&store_name=".$StoreName);
	 }
}
...
if($_POST['activate']=="Link/Activate") {
	...
	/* register api*/
		echo $url = "https://pim-app-dev.unbxd.io/pim/v1/register";
	 $ch = curl_init($url);
...
if ($resultupdate->num_rows > 0) {
 ...
 $sqlupdate = "UPDATE pim_users SET api_key= '".$get_api_key."' where id=".$row1['id'];
...
$reslt1 = json_decode($result);
 ...
 $get_apiresult = $get_apiresult['data']['org_list'];
if ($bc_org_key){
...
<div class='loader'>	
	...
	<?php foreach ($get_apiresult as $get_apiresultval ) { ?>
	<option value="<?php echo $get_apiresultval['name']; ?> ">
	<?php echo $get_apiresultval['name']; ?> </option>				
	<?php 	 }
 ?>	
...
<form action="Pim_Form.php?id=<?php echo $Store_Hash;  ?>" method="post" class="m0">
  <div class="container">
  <div class="wrpr-main">
	<div class="d-block">
	<div class="hdng">
